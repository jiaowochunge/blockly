...
Blockly.Msg.BELL_SENSOR_SWITCH_HELPURL = 'file://' + __dirname + '/guide/Gyro.html';
Blockly.Msg.BELL_SYSTEM_GET_TIME_TITLE = "系统时间";
Blockly.Msg.BELL_SYSTEM_GET_TIME_TOOLTIP = "获得机器人内部系统时间";
Blockly.Msg.BELL_SYSTEM_GET_TIME_HELPURL = 'file://' + __dirname + '/guide/SystemTime.html';
Blockly.Msg.BELL_SYSTEM_RESET_TIME_TITLE = "重置系统时间";
Blockly.Msg.BELL_SYSTEM_RESET_TIME_TOOLTIP = "重置机器人内部系统时间";
Blockly.Msg.BELL_SYSTEM_RESET_TIME_HELPURL = 'file://' + __dirname + '/guide/SystemTime.html';
Blockly.Msg.BELL_PHYSICAL_BUTTON_TITLE = "当按钮 %1 按下时";
Blockly.Msg.BELL_PHYSICAL_BUTTON_TOOLTIP = "";
Blockly.Msg.BELL_PHYSICAL_BUTTON_HELPURL = 'file://' + __dirname + '/guide/RemotePanel.html';
Blockly.Msg.BELL_REMOTE_RATIO_TITLE = "遥控比例系数";
Blockly.Msg.BELL_REMOTE_RATIO_TOOLTIP = "";
Blockly.Msg.BELL_REMOTE_RATIO_HELPURL = 'file://' + __dirname + '/guide/Button.html';
Blockly.Msg.BELL_REMOTE_COORDINATE_TITLE = "%1 遥控坐标";
Blockly.Msg.BELL_REMOTE_COORDINATE_TOOLTIP = "手机App的遥控坐标";
Blockly.Msg.BELL_REMOTE_COORDINATE_HELPURL = 'file://' + __dirname + '/guide/RemotePanel.html';
Blockly.Msg.BELL_REMOTE_POWER_TITLE = "%1 遥控功率";
Blockly.Msg.BELL_REMOTE_POWER_TOOLTIP = "经过换算之后的电机功率";
Blockly.Msg.BELL_REMOTE_POWER_HELPURL = 'file://' + __dirname + '/guide/RemotePanel.html';
// ======================= bell-logic ==========================
Blockly.Msg.BELL_LOGIC_COMPARE_EQ_TOOLTIP = "两个数相等时返回真";
Blockly.Msg.BELL_LOGIC_COMPARE_EQ_HELPURL = 'file://' + __dirname + '/guide/Newtopic14.html';
Blockly.Msg.BELL_LOGIC_COMPARE_NEQ_TOOLTIP = "两个数不相等时返回真";
Blockly.Msg.BELL_LOGIC_COMPARE_NEQ_HELPURL = 'file://' + __dirname + '/guide/Newtopic15.html';
Blockly.Msg.BELL_LOGIC_COMPARE_LT_TOOLTIP = "第一个数小于第二个数时返回真";
Blockly.Msg.BELL_LOGIC_COMPARE_LT_HELPURL = 'file://' + __dirname + '/guide/Newtopic13.html';
Blockly.Msg.BELL_LOGIC_COMPARE_LTE_TOOLTIP = "第一个数小于或等于第二个数时返回真";
Blockly.Msg.BELL_LOGIC_COMPARE_LTE_HELPURL = 'file://' + __dirname + '/guide/Newtopic16.html';
Blockly.Msg.BELL_LOGIC_COMPARE_GT_TOOLTIP = "第一个数大于第二个数时返回真";
Blockly.Msg.BELL_LOGIC_COMPARE_GT_HELPURL = 'file://' + __dirname + '/guide/Newtopic12.html';
Blockly.Msg.BELL_LOGIC_COMPARE_GTE_TOOLTIP = "第一个数大于或等于第二个数时返回真";
Blockly.Msg.BELL_LOGIC_COMPARE_GTE_HELPURL = 'file://' + __dirname + '/guide/Newtopic17.html';
Blockly.Msg.BELL_LOGIC_OPERATION_AND_TOOLTIP = "逻辑与";
Blockly.Msg.BELL_LOGIC_OPERATION_AND_HELPURL = 'file://' + __dirname + '/guide/And.html';
Blockly.Msg.BELL_LOGIC_OPERATION_OR_TOOLTIP = "逻辑或";
Blockly.Msg.BELL_LOGIC_OPERATION_OR_HELPURL = 'file://' + __dirname + '/guide/Or.html';
Blockly.Msg.BELL_LOGIC_OPERATION_NOT_TOOLTIP = "逻辑非";
Blockly.Msg.BELL_LOGIC_OPERATION_NOT_HELPURL = 'file://' + __dirname + '/guide/Not.html';
// ======================= bell-math ==========================
...
Blockly.Msg.BELL_MATH_RANDOM_INT_HELPURL = 'file://' + __dirname + '/guide/PickRandom.html';
// 取绝对值block label
Blockly.Msg.BELL_MATH_ABS_TITLE = "绝对值 %1";
Blockly.Msg.BELL_MATH_ABS_TOOLTIP = "返回绝对值";
Blockly.Msg.BELL_MATH_ABS_HELPURL = 'file://' + __dirname + '/guide/AbsoluteValue.html';
