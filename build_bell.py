...
proxies = {
    "http": "socks5://:kim@makcoo@127.0.0.1:1080"
}
...
""")
    f.close()
    print("chenhj1 SUCCESS: " + target_filename)
...
class Gen_compressed(threading.Thread):
  ...
  def do_compile(self, params, target_filename, filenames, remove):
    ...
    resp = requests.post('http://closure-compiler.appspot.com/compile',
     proxies=proxies, data=urllib.urlencode(params), headers=headers)
    json_data = resp.json()
